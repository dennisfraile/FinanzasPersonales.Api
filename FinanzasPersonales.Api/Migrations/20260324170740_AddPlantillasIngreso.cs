...
{
    /// <inheritdoc />
    public partial class AddPlantillasIngreso : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "PlantillasIngreso",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlantillasIngreso", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlantillasIngreso_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlantillasIngreso_Categorias_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PlantillasIngreso_Cuentas_CuentaId",
                        column: x => x.CuentaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlantillasIngreso_CategoriaId",
                table: "PlantillasIngreso",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_PlantillasIngreso_CuentaId",
                table: "PlantillasIngreso",
                column: "CuentaId");

            migrationBuilder.CreateIndex(
                name: "IX_PlantillasIngreso_UserId",
                table: "PlantillasIngreso",
                column: "UserId");
        }
